...
moduleForModel('i-i-s-otdel-kadrov-2-приказ-о-приеме', 'Unit | Serializer | i-i-s-otdel-kadrov-2-приказ-о-приеме', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-otdel-kadrov-2-приказ-о-приеме',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
